...
import '../controller/base_bottom_controller.dart';
...
class BaseBottomBar extends StatelessWidget {
  ...
  BaseBottomBar({Key? key, required this.onNewMenuSelected}) : super(key: key);
  // late AppLocalizations appLocalization;

  final navController = BaseBottomController();
